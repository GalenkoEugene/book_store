...
class CreditCard < ApplicationRecord
  ...
  validates_format_of :number, with: %r{\A\d{16}\z}, message: I18n.t('validation.cart_number')
  validates_format_of :name, with: %r{\A[a-zA-Z\s]{0,49}\z}, message: I18n.t('validation.cart_name')
