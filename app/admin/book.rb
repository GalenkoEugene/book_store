ActiveAdmin.register Book do
  ...
  form html: { multipart: true } do |f|
    f.inputs "Resource Details" do
      ...
      f.input :active
      f.input :price
      f.input :category, as: :select, collection: Category.pluck(:type_of, :id), include_blank: false
      f.input :description
      f.input :materials
      f.input :height
      f.input :weight
      ...
      hint = f.object.images.map{|i| image_tag(i.file, size: '50x60') }.join.html_safe if f.object.images
